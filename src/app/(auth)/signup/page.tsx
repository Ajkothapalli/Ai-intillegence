    ...
    <main className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-sm bg-[var(--surface)] rounded-xl border border-[var(--border)] shadow-[var(--shadow-md)] p-8 space-y-6">
        <div>
          ...
          <p className="text-sm text-[var(--foreground-muted)] mt-1">Start turning data into experiments</p>
        </div>
        ...
        <form action={formAction} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input id="fullName" name="fullName" type="text" autoComplete="name" required placeholder="Jane Smith" />
          </div>
        ...
        <p className="text-sm text-center text-[var(--foreground-muted)]">
          ...
          <Link href="/login" className="text-[var(--forest-400)] hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
